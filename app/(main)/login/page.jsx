    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Sign in to continue your training journey</p>
        </div>
        <div className="card p-7">
          ...
          <div className="relative my-5">
            ...
            <div className="relative text-center"><span className="px-3 bg-dark-card text-xs text-gray-500">OR</span></div>
          </div>
