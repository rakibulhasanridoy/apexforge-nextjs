...
function AdminAddPostContent() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['forum'] }); reset(); toast.success('Post published!') },
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-gray-500 text-sm mb-8">Post announcements and updates to the community forum.</p>
      <div className="card p-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div>
            <label className="label">Post Title</label>
            <input {...register('title', { required: 'Required' })} className="input" placeholder="e.g. New Equipment Arriving Next Week" />
          ...
          <div>
            ...
            <textarea {...register('description', { required: 'Required', minLength: { value: 20, message: 'Min 20 characters' } })} rows={8} className="input resize-none" placeholder="Write your announcement or article..." />
...
export default function AdminAddPostPage() {
  return <RoleGuard roles={['admin']}><AdminAddPostContent /></RoleGuard>
}
